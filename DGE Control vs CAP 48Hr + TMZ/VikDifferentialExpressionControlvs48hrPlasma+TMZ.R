...
setwd("~/tyson/VikasDifferentialExpressionControlvs48hrPlasma+TMZ")
...
res <- results(dds,
               contrast=c("Treatment", "Plasma48hrTMZ", "Control"),
               alpha = 0.05,
               pAdjustMethod = "BH",
...
dev.off()
write.csv(as.data.frame(res.sig.48hrTMZ), file = "Controlvs48hrTMZ.csv")